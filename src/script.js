...
const doorMetalnessexture = textureLoader.load('./door/metalness.webp')
...
gui.add(floor.material, 'displacementScale').min(0).max(1).step(0.001).name('floorDiplacementScale')
gui.add(floor.material, 'displacementBias').min(-1).max(1).step(0.001).name('floorDiplacementBias')
...
const door = new THREE.Mesh(
    ...
    new THREE.MeshStandardMaterial({ 
        ...
        metalnessMap: doorMetalnessexture,
...
// gui.add(doorLight.position, 'x').min(-5).max(5).step(0.2).name('x')
// gui.add(doorLight.position, 'y').min(-5).max(5).step(0.2).name('y')
// gui.add(doorLight.position, 'z').min(-5).max(5).step(0.2).name('z')
